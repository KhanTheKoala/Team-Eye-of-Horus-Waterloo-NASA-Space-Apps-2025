...
params = {
    ...
    "longitude": lon,
    "community": "ag",
    "parameters": "T2M,T2M_MIN,T2M_MAX,T2MDEW,PRECTOTCORR,RH2M,QV2M,WS10M,ALLSKY_SFC_SW_DWN,ALLSKY_SFC_LW_DWN,T2MWET,TS,WD10M,IMERG_PRECLIQUID_PROB,ALLSKY_SFC_UV_INDEX",
    "format": "json",
    "units": "metric",
    "user": "T123",
    "header": "true",
...
data = response.json()
print(quick_convert(data,"nasapastdataadvpara"))
print(quick_convert_coordinate(data,"nasapastdatacoordinateadvpara"))
